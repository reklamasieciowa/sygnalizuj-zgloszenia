...
<div class="container-fluid">
    ...
    <div class="row mb-3">
      <div class="col-lg-12">
        <h2 class="h3-responsive">
          Zgłoszenia ze statusem {{ $status->name }}: 
        </h2>
      </div>
    </div>
    <div class="row">
  ...
  <a href="{{ route('statuses') }}" title="Wróć do listy statusów" class="btn btn-info"><i class="far fa-arrow-alt-circle-left fa-lg mr-2"></i> Wróć do listy statusów</a>
</div>
</div>
@endsection
