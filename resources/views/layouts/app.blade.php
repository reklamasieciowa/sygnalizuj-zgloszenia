      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav mr-auto">
            @if (Auth::check())
              <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.home') }}"><i class="fas fa-cogs fa-lg"></i> Panel zarządzania</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="{{ route('entries') }}"><i class="fas fa-envelope-open-text fa-lg"></i> Zgłoszenia</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="{{ route('statuses') }}"><i class="fas fa-flag fa-lg"></i> Statusy</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="{{ route('subjects') }}"><i class="far fa-comment-dots fa-lg"></i> Tematy</a>
              </li>
            @endif
          </ul>
           @if (Auth::check())
    ...
    <div class="container text-center text-md-left">
      <div class="row">
        <div class="col-md-3 mx-auto">
          ...
          <p class="mt-3">{{ config('app.name', 'Sygnalizuj') }}</p>
        </div>
        <hr class="clearfix w-100 d-md-none">
        <div class="col-md-3 mx-auto">
          <div id="nav_menu-2" class="footer-info widget_nav_menu">
            <h5 class="h5-responsive font-weight-bold mt-3 mb-2">Informacje</h5>
          ...
          <div class="col-md-3 mx-auto">
            <div id="nav_menu-4" class="footer-info widget_nav_menu">
              <h5 class="h5-responsive font-weight-bold mt-3 mb-2">Oferta</h5>
          ...
          <div class="col-md-3 mx-auto">
            <div id="nav_menu-3" class="footer-info widget_nav_menu">
              <h5 class="h5-responsive font-weight-bold mt-3 mb-2">Zgłoszenia</h5>
        ...
        <div class="text-center my-4">
          <a href="{{ route('entry.create') }}" class="btn btn-danger waves-effect waves-light" role="button">Prześlij zgłoszenie <i class="fas fa-paper-plane fa-lg ml-2"></i></a>
          <a href="http://sygnalizuj.com/rekomendacja/" target="_blank" class="btn btn-light-gray waves-effect waves-light" role="button">Zarekomenduj Sygnalizuj.com <i class="fas fa-thumbs-up fa-lg ml-2"></i></a>
        </div>
      </div>
